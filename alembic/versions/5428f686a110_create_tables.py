...
Revision ID: 5428f686a110
Revises: 
Create Date: 2025-12-10 09:11:35.998605
...
def upgrade() -> None:
    ...
    # Create users first (messages and other tables depend on users)
    ...
    # Create conversations WITHOUT last_message columns to avoid FK -> messages
    ...
    # Now create messages which depend on conversations and users
    ...
    # Now add last_message columns and FK to conversations (messages table exists now)
